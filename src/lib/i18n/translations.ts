...
export const translations = {
  en: {
    ...
    newQuoteTitle: "New Motor Quote",
    downloadInvoice: "Download Invoice PDF",
    invoiceReviewDesc: "Verify invoice details, then download the PDF.",
    invoiceTotalDue: "Total Amount Due",
    close: "Close",
    cancel: "Cancel",
    back: "Back",
    next: "Next",
    ...
    invoiceSteps: {
      header: { title: "Invoice Header", desc: "Invoice number and date." },
      customer: { title: "Customer & Vehicle", desc: "Customer and vehicle details." },
      fees: { title: "Fee Details", desc: "Fee description, amount, and notes." },
      notes: { title: "Notes & Footer", desc: "Invoice notes and footer text." },
    },
    invoiceSections: {
    ...
    invoiceFields: {
      ...
      feeAmount: "Amount (AED)",
      feeNotes: "Notes",
      note1: "Note 1",
      note2: "Note 2",
      footerMessage: "Footer Message",
      footerWebsite: "Website URL",
    },
    options: {
  ...
  ar: {
    ...
    invoiceReviewDesc: "تحقق من بيانات الفاتورة ثم حمّل ملف PDF.",
    invoiceTotalDue: "إجمالي المبلغ المستحق",
    close: "إغلاق",
    cancel: "إلغاء",
    back: "رجوع",
    next: "التالي",
    ...
    invoiceSteps: {
      header: { title: "رأس الفاتورة", desc: "رقم الفاتورة وتاريخها." },
      customer: { title: "العميل والمركبة", desc: "بيانات العميل والمركبة." },
      fees: { title: "تفاصيل الرسوم", desc: "البيان والمبلغ والملاحظات." },
      notes: { title: "الملاحظات والتذييل", desc: "ملاحظات الفاتورة ونص التذييل." },
    },
    invoiceSections: {
      header: "رأس الفاتورة",
      customer: "العميل والمركبة",
      fees: "تفاصيل الرسوم",
      notes: "الملاحظات والتذييل",
    },
    fields: {
    ...
    invoiceFields: {
      ...
      feeDescription: "البيان",
      feeAmount: "المبلغ (درهم)",
      feeNotes: "ملاحظات",
      note1: "ملاحظة 1",
      note2: "ملاحظة 2",
      footerMessage: "رسالة التذييل",
      footerWebsite: "رابط الموقع",
    },
    options: {
      individual: "فرد",
      company: "شركة",
